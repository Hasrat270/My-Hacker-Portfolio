    ...
    <section className="min-h-screen bg-[#0a0a0a] flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href="#machines"
            className="font-mono text-sm text-[#0a0a0a] bg-[#00ff41] px-6 py-3 rounded hover:bg-[#00ff41]/80 transition-colors duration-200 w-full sm:w-auto"
          >
            $ ./view-work.sh
          </a>
          <a
            href="#contact"
            className="font-mono text-sm text-[#00ff41] border border-[#00ff41]/40 px-6 py-3 rounded hover:bg-[#00ff41]/10 hover:border-[#00ff41] transition-all duration-200 w-full sm:w-auto"
          >
            $ ./contact-me.sh
          </a>
        </div>
